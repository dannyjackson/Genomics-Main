...
do
    ...
    echo "COMMAND: apptainer run ${PROGDIR}/smcpp_latest.sif vcf2smc ${VCF} ${OUTDIR}/datafiles/demography/smc_inputs/${chr}.smc.gz ${chr} ${POPSET} --mask ${OUTDIR}/datafiles/snpable/${prefix}_revised_mask.${chr}.mask.bed.gz"
