...
printf "\n\n\n\n"
date
echo "Current script: A0.2_alignandsort.sh"
...
if [ "$TRIMMETHOD" = "trimmomatic" ]; then
    ...
    FASTA1="${OUTDIR}/datafiles/trimmed_fastas/${IND}_trimmed_R1.fq.gz"
    FASTA2="${OUTDIR}/datafiles/trimmed_fastas/${IND}_trimmed_R2.fq.gz"
fi
