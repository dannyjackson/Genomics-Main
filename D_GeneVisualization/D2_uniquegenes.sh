...
source "$PARAMS"
grep -Fxv -f "${OUTDIR}/analyses/genelist/gene_names/${POP2}.${METRIC}.${WIN}.genenames.txt" \
            "${OUTDIR}/analyses/genelist/gene_names/${POP1}.${METRIC}.${WIN}.genenames.txt" > \
            "${OUTDIR}/analyses/genelist/final_gene_lists/${POP1}.${METRIC}.${WIN}.unique.genenames.txt"
