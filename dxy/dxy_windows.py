...
# Load the dxy data
dxy_data = pd.read_csv(f"{args.outdir}/analyses/dxy/snps/{args.pop1}_{args.pop2}/Dxy_persite_{args.pop1}_{args.pop2}.autosomes.txt", sep="\t", dtype={"chromo": str, "position": int, "dxy": float})
