...
# Load the dxy data
dxy_data = pd.read_csv(f"{args.outdir}/analyses/dxy/{args.pop1}_{args.pop2}/snps/Dxy_persite_{args.pop1}_{args.pop2}.txt", sep="\t", dtype={"chromo": str, "position": int, "dxy": float})
