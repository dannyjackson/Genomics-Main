...
if [ $NR_IND == 1 ]
        ...
        msmc2_Linux -t 16 -p $P_PAR -i 100 -o $MSMC_OUTPUT -I 0,1 $MSMC_INPUT
        ...
        msmc2_Linux -t 16 -p $P_PAR -i 100 -o ${MSMC_OUTPUT} -I `echo $INDEX` $MSMC_INPUT
