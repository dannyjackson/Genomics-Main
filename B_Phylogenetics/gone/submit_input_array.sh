...
ARRAY_NAME=input_run2 # Be sure to rename this parameter if you wish to keep mulitple input runs. Otherwise, all files in an existing array folder will be overwritten.
